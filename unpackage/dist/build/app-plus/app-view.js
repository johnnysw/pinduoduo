...
var z=gz$gwx_1()
var oB=_n('view')
var xC=_mz(z,'view',['bindtap',0,'bindtouchstart',1,'class',1,'data-event-opts',2],[],e,s,gg)
var oD=_mz(z,'scroll-view',['class',4,'scrollIntoView',1,'scrollTop',2,'scrollWithAnimation',3,'scrollY',4,'upperThreshold',5],[],e,s,gg)
var fE=_n('view')
...
var hU=_mz(z,'view',['class',25,'id',1],[],oR,xQ,gg)
var oV=_v()
_(hU,oV)
if(_oz(z,27,oR,xQ,gg)){oV.wxVkey=1
var oX=_n('view')
_rz(z,oX,'class',28,oR,xQ,gg)
var lY=_v()
_(oX,lY)
if(_oz(z,29,oR,xQ,gg)){lY.wxVkey=1
var aZ=_n('view')
_rz(z,aZ,'class',30,oR,xQ,gg)
var t1=_oz(z,31,oR,xQ,gg)
_(aZ,t1)
_(lY,aZ)
}
lY.wxXCkey=1
...
var e2=_v()
_(cW,e2)
if(_oz(z,33,oR,xQ,gg)){e2.wxVkey=1
var o4=_n('view')
_rz(z,o4,'class',34,oR,xQ,gg)
var x5=_n('view')
_rz(z,x5,'class',35,oR,xQ,gg)
var o6=_v()
_(x5,o6)
if(_oz(z,36,oR,xQ,gg)){o6.wxVkey=1
var c8=_n('view')
_rz(z,c8,'class',37,oR,xQ,gg)
var h9=_n('rich-text')
_rz(z,h9,'nodes',38,oR,xQ,gg)
_(c8,h9)
_(o6,c8)
}
var f7=_v()
_(x5,f7)
if(_oz(z,39,oR,xQ,gg)){f7.wxVkey=1
var o0=_mz(z,'view',['bindtap',40,'class',1,'data-event-opts',2],[],oR,xQ,gg)
var cAB=_mz(z,'image',['src',43,'style',1],[],oR,xQ,gg)
_(o0,cAB)
_(f7,o0)
}
o6.wxXCkey=1
...
_(o4,x5)
var oBB=_n('view')
_rz(z,oBB,'class',45,oR,xQ,gg)
var lCB=_n('image')
_rz(z,lCB,'src',46,oR,xQ,gg)
_(oBB,lCB)
_(o4,oBB)
_(e2,o4)
}
var b3=_v()
_(cW,b3)
if(_oz(z,47,oR,xQ,gg)){b3.wxVkey=1
var aDB=_n('view')
_rz(z,aDB,'class',48,oR,xQ,gg)
var tEB=_n('view')
_rz(z,tEB,'class',49,oR,xQ,gg)
var eFB=_n('image')
_rz(z,eFB,'src',50,oR,xQ,gg)
_(tEB,eFB)
_(aDB,tEB)
var bGB=_n('view')
_rz(z,bGB,'class',51,oR,xQ,gg)
var oJB=_n('view')
_rz(z,oJB,'class',52,oR,xQ,gg)
var fKB=_n('view')
_rz(z,fKB,'class',53,oR,xQ,gg)
var cLB=_oz(z,54,oR,xQ,gg)
_(fKB,cLB)
_(oJB,fKB)
var hMB=_n('view')
_rz(z,hMB,'class',55,oR,xQ,gg)
var oNB=_oz(z,56,oR,xQ,gg)
_(hMB,oNB)
_(oJB,hMB)
_(bGB,oJB)
var oHB=_v()
_(bGB,oHB)
if(_oz(z,57,oR,xQ,gg)){oHB.wxVkey=1
var cOB=_n('view')
_rz(z,cOB,'class',58,oR,xQ,gg)
var oPB=_n('rich-text')
_rz(z,oPB,'nodes',59,oR,xQ,gg)
_(cOB,oPB)
_(oHB,cOB)
}
var xIB=_v()
_(bGB,xIB)
if(_oz(z,60,oR,xQ,gg)){xIB.wxVkey=1
var lQB=_mz(z,'view',['bindtap',61,'class',1,'data-event-opts',2],[],oR,xQ,gg)
var aRB=_mz(z,'image',['src',64,'style',1],[],oR,xQ,gg)
_(lQB,aRB)
_(xIB,lQB)
}
oHB.wxXCkey=1
...
var eTB=_mz(z,'swiper',['class',67,'duration',1,'indicatorDots',2],[],e,s,gg)
var bUB=_v()
_(eTB,bUB)
...
var e8B=_mz(z,'view',['bindtap',78,'data-event-opts',1],[],l5B,o4B,gg)
var b9B=_mz(z,'image',['mode',80,'src',1],[],l5B,o4B,gg)
_(e8B,b9B)
_(a6B,e8B)
return a6B
}
o2B.wxXCkey=2
_2z(z,76,c3B,oXB,xWB,gg,o2B,'em','eid','eid')
_(fYB,h1B)
return fYB
}
bUB.wxXCkey=2
_2z(z,72,oVB,e,s,gg,bUB,'page','pid','pid')
_(tSB,eTB)
var o0B=_n('view')
_rz(z,o0B,'class',82,e,s,gg)
var xAC=_n('view')
_rz(z,xAC,'class',83,e,s,gg)
var oBC=_mz(z,'view',['bindtap',84,'class',1,'data-event-opts',2],[],e,s,gg)
var fCC=_n('view')
...
var oHC=_mz(z,'textarea',['autoHeight',92,'bindfocus',1,'bindinput',2,'data-event-opts',3,'placeholder',4,'value',5],[],e,s,gg)
_(cGC,oHC)
_(oFC,cGC)
var lIC=_mz(z,'view',['bindtap',98,'class',1,'data-event-opts',2],[],e,s,gg)
var aJC=_n('view')
...
_(hEC,oFC)
_(cDC,hEC)
var tKC=_mz(z,'view',['bindtap',102,'class',1,'data-event-opts',2],[],e,s,gg)
var eLC=_n('view')
_rz(z,eLC,'class',105,e,s,gg)
_(tKC,eLC)
_(cDC,tKC)
var bMC=_mz(z,'view',['bindtap',106,'class',1,'data-event-opts',2],[],e,s,gg)
var oNC=_n('view')
