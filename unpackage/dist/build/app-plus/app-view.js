...
var oV=_mz(z,'view',['class',26,'id',1],[],fS,oR,gg)
var cW=_v()
_(oV,cW)
...
var aZ=_v()
_(lY,aZ)
if(_oz(z,30,fS,oR,gg)){aZ.wxVkey=1
var t1=_n('view')
_rz(z,t1,'class',31,fS,oR,gg)
...
var oX=_v()
_(oV,oX)
if(_oz(z,33,fS,oR,gg)){oX.wxVkey=1
var b3=_v()
_(oX,b3)
...
var f7=_v()
_(o6,f7)
if(_oz(z,37,fS,oR,gg)){f7.wxVkey=1
var h9=_n('view')
_rz(z,h9,'class',38,fS,oR,gg)
var o0=_n('rich-text')
_rz(z,o0,'nodes',39,fS,oR,gg)
_(h9,o0)
_(f7,h9)
}
var c8=_v()
_(o6,c8)
if(_oz(z,40,fS,oR,gg)){c8.wxVkey=1
var cAB=_mz(z,'view',['bindtap',41,'class',1,'data-event-opts',2],[],fS,oR,gg)
var oBB=_mz(z,'image',['src',44,'style',1],[],fS,oR,gg)
_(cAB,oBB)
_(c8,cAB)
}
f7.wxXCkey=1
...
_(x5,o6)
var lCB=_n('view')
_rz(z,lCB,'class',46,fS,oR,gg)
var aDB=_n('image')
_rz(z,aDB,'src',47,fS,oR,gg)
_(lCB,aDB)
_(x5,lCB)
_(b3,x5)
}
var o4=_v()
_(oX,o4)
if(_oz(z,48,fS,oR,gg)){o4.wxVkey=1
var tEB=_n('view')
_rz(z,tEB,'class',49,fS,oR,gg)
var eFB=_n('view')
_rz(z,eFB,'class',50,fS,oR,gg)
var bGB=_n('image')
_rz(z,bGB,'src',51,fS,oR,gg)
_(eFB,bGB)
_(tEB,eFB)
var oHB=_n('view')
_rz(z,oHB,'class',52,fS,oR,gg)
var fKB=_n('view')
_rz(z,fKB,'class',53,fS,oR,gg)
var cLB=_n('view')
_rz(z,cLB,'class',54,fS,oR,gg)
var hMB=_oz(z,55,fS,oR,gg)
_(cLB,hMB)
_(fKB,cLB)
var oNB=_n('view')
...
var xIB=_v()
_(oHB,xIB)
if(_oz(z,58,fS,oR,gg)){xIB.wxVkey=1
var oPB=_n('view')
_rz(z,oPB,'class',59,fS,oR,gg)
var lQB=_n('rich-text')
_rz(z,lQB,'nodes',60,fS,oR,gg)
_(oPB,lQB)
_(xIB,oPB)
}
var oJB=_v()
_(oHB,oJB)
if(_oz(z,61,fS,oR,gg)){oJB.wxVkey=1
var aRB=_mz(z,'view',['bindtap',62,'class',1,'data-event-opts',2],[],fS,oR,gg)
var tSB=_mz(z,'image',['src',65,'style',1],[],fS,oR,gg)
_(aRB,tSB)
_(oJB,aRB)
}
xIB.wxXCkey=1
...
oP.wxXCkey=2
_2z(z,24,xQ,e,s,gg,oP,'row','index','index')
_(xC,oD)
_(oB,xC)
var eTB=_n('view')
_rz(z,eTB,'class',67,e,s,gg)
var bUB=_mz(z,'swiper',['class',68,'duration',1,'indicatorDots',2],[],e,s,gg)
var oVB=_v()
_(bUB,oVB)
...
var b9B=_mz(z,'view',['bindtap',79,'data-event-opts',1],[],a6B,l5B,gg)
var o0B=_mz(z,'image',['mode',81,'src',1],[],a6B,l5B,gg)
_(b9B,o0B)
_(t7B,b9B)
return t7B
}
c3B.wxXCkey=2
_2z(z,77,o4B,fYB,oXB,gg,c3B,'em','eid','eid')
_(cZB,o2B)
return cZB
}
oVB.wxXCkey=2
_2z(z,73,xWB,e,s,gg,oVB,'page','pid','pid')
_(eTB,bUB)
var xAC=_n('view')
_rz(z,xAC,'class',83,e,s,gg)
var oBC=_n('view')
_rz(z,oBC,'class',84,e,s,gg)
var fCC=_mz(z,'view',['bindtap',85,'class',1,'data-event-opts',2],[],e,s,gg)
var cDC=_n('view')
...
var lIC=_mz(z,'textarea',['autoHeight',93,'bindfocus',1,'bindinput',2,'data-event-opts',3,'placeholder',4,'value',5],[],e,s,gg)
_(oHC,lIC)
_(cGC,oHC)
var aJC=_mz(z,'view',['bindtap',99,'class',1,'data-event-opts',2],[],e,s,gg)
var tKC=_n('view')
...
_(oFC,cGC)
_(hEC,oFC)
var eLC=_mz(z,'view',['bindtap',103,'class',1,'data-event-opts',2],[],e,s,gg)
var bMC=_mz(z,'image',['class',106,'src',1],[],e,s,gg)
_(eLC,bMC)
_(hEC,eLC)
var oNC=_mz(z,'view',['bindtap',108,'class',1,'data-event-opts',2],[],e,s,gg)
var xOC=_n('view')
